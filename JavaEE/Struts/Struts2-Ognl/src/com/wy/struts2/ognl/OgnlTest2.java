...
public class OgnlTest2 {
	...
	public static void main(String[] args) throws OgnlException {
		...
		System.out.println(Ognl.getValue("@com.wy.struts2.ognl.OgnlBean@staticProperty", context));
		System.out.println(Ognl.getValue("@com.wy.struts2.ognl.OgnlBean@staticMethod()", context));
		...
		teacherList.add(new Teacher("Jack3", 2500));
		teacherList.add(new Teacher("Jack4", 2400));
		teacherList.add(new Teacher("Jack5", 2700));
		teacherList.add(new Teacher("Jack6", 2900));
