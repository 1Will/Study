...
<table align="center" border="1" cellspacing="0" width="500">
	...
	<tr>
				<th>体重</th>
				<td align="left"><input type="text" id="weight"
					name="users.weight" value="${users.weight}" /></td>
			</tr>
	<tr>
		<th>薪水</th>
		<td align="left"><input type="text" id="salary" name="users.salary" value="${users.salary}" /></td>
	</tr>	
...
$(document).ready(function(){
	...
	$("#age").attr("datatype","Require").attr("msg","请填写您的薪水！");
