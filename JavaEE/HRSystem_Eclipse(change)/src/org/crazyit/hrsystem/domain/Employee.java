	...
	implements Serializable
{
	...
	//以下为新增字段by WY
	//员工性别
	@Column(name="emp_sex" , nullable=false, length=5 ,columnDefinition="varchar(10) default '未设置'")
	private String sex;
	//员工年龄
	@Column(name="emp_age" , nullable=false ,columnDefinition="int default 0")
	private int age;
	...
	public Employee(Integer id , String name , String pass ,
		...
		Set<Attend> attends , Set<Payment> payments,String sex ,int age)
	{
		this.id = id;
		this.name = name;
		this.pass = pass;
