...
import com.wy.mybatis.domain.UserInfo;
...
public class Test {
	...
	public void init2() throws Exception {
		...
		session = new SqlSessionFactoryBuilder().build(Resources.getResourceAsStream(resource)).openSession();
	}
