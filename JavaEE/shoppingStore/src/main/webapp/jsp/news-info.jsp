...
<!--消息内容-->
<div class="info-info">
	<dl class="info-des clearfix">
		<dt>问题描述：</dt>
		<dd>
			<p>时间： 2016.09.01</p>
			<p>标题： 提现未到帐</p>
			<p class="con1">内容： 您好，本人赵某某，于2016年8月30日18:20申请提现2000元，但现查询银行卡上余额显示仍.未到帐，请帮我处理并回复，谢谢。</p>
		</dd>
	</dl>
	<dl class="info-reply clearfix">
		<dt>平台回复内容：</dt>
		<dd>
			<p>您好，后台已为您处理，且余额已到帐，有问题再联系，感谢您的支持，谢谢。</p>
		</dd>
	</dl>
	<div class="info-fh"><a href="news.jsp">返回</a></div>
</div>
<!--/消息内容-->
<!--service-->
