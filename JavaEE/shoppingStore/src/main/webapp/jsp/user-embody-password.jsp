		...
		<ul>
			...
			<li>
				...
				<div class="cust-nav">
					...
					<p class="on"><a href="user-embody-password.jsp">提现密码设置</a></p>
		...
		<div class="setpass">
			...
			<div class="set-p">
				<dl class="clearfix">
					<dt>原密码：</dt>
					<dd>
						<input type="text" name="" class="input shuru1 input_cur1">
						<span class="jp-btn" onclick="gb1();"></span>
						<div class="jpp"></div>
					</dd></dl>
				<dl class="clearfix">
					<dt>新密码：</dt>
					<dd>
						<input type="text" name="" class="input shuru2 input_cur2">
						<span class="jp-btn" onclick="gb2();"></span>
						<div class="jpp"></div>
					</dd>
				</dl>
				<dl class="clearfix">
					<dt>确认密码：</dt>
					<dd>
						<input type="text" name="" class="input shuru3 input_cur3">
						<span class="jp-btn" onclick="gb3();"></span>
						<div class="jpp"></div>
					</dd>
				</dl>
			</div>
			<div class="addr-btn mt50">
				<a href="">保存</a>
			</div>
		</div>
	</div>
