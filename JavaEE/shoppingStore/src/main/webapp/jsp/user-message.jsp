...
<div class="customer w1200 clearfix">
		...
		<ul>
			...
			<li>
				...
				<div class="cust-nav">
					...
					<p class="on"><a href="user-message.jsp">我的留言</a></p>
				</div>
			</li>
		</ul>
	</div>
	...
	<div class="w1018 fr">
		<!---->
		<div class="leaving">
			<dl class="clearfix"><dt>留言主题</dt><dd><input type="text" placeholder="请输入留言主题"></dd></dl>
			<dl class="leaving-con clearfix"><dt>留言内容</dt><dd><textarea type="text" placeholder="请输入留言内容"></textarea></dd></dl>
