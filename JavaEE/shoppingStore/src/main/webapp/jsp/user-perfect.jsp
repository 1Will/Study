...
<div class="customer w1200 clearfix">
		...
		<ul>
			...
			<li>
				...
				<div class="cust-nav">
					...
					<p class="on"><a href="user-perfect.jsp">完善资料</a></p>
	...
	<div class="w1018 fr">
		<!--完善资料-->
		<div class="perfect">
			<div class="perfect-user"><img src="images/user.jpg" alt=""><a class="modify-user" href="javascript:;">修改</a></div>
			<div class="perfect-dl">
				<dl class="clearfix"><dt>会&nbsp;&nbsp;员&nbsp;&nbsp;ID：</dt><dd class="perfect-dd"><span>80001247 <i></i></span><em>上一级：刘丽丽</em></dd></dl>
				<dl class="clearfix"><dt><span>*</span>昵&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;称：</dt><dd><input type="text" placeholder="豆芽子"></dd></dl>
				<dl class="clearfix"><dt><span>*</span>微&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;信：</dt><dd><input type="text" placeholder="xielixeixnlwie"></dd></dl>
				<dl class="clearfix"><dt><span>*</span>真实姓名：</dt><dd><input type="text" placeholder="张六六"></dd></dl>
				<dl class="clearfix"><dt><span>*</span>手&nbsp;机&nbsp;号&nbsp;：</dt><dd><input type="text" placeholder="13311111111"></dd></dl>
				<dl class="clearfix"><dt><span>*</span>出生日期：</dt><dd><input type="text" placeholder="1988年8月8日"></dd></dl>
			</div>
			<div class="addr-btn perfect-btn mt50">
				<a href="">保存</a>
			</div>
			<div class="perfect-p">
				<h3>推荐人信息</h3>
				<p><span>真实姓名：</span>刘丽丽</p>
				<p><span>加入日期：</span>2016-04-23 06：01</p>
				<p><span>会员ID：</span>80001111</p>
				<p><span>微信号：</span>liulili1314</p>
			</div>
...
<!--自定义表单-->
<div class="portrait">
	<div class="portrait-tit">
		<h3>自定义头像</h3>
		<span class="withd-gb"></span>
	</div>
	<div class="portrait-file clearfix">
		<div class="file-in"><input type="file"><span>上传头像</span></div>
		<div>支持大小不超过5M的jpg、png图片</div>
	</div>
	<div class="portrait-info clearfix">
		<div class="portrait-next"></div>
		<div class="portrait-preview fr">
			<h4>预览</h4>
	...
	<div class="portrait-btn">
		<a class="por-btn1" href="javascript:;">保存</a>
		<a class="por-btn2" href="javascript:;">取消</a>
	</div>
</div>
<!--登陆-->
<div class="pop"></div>
