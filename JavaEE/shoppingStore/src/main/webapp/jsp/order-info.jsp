	...
	<div class="w1018 fr">
		...
		<div class="order-con">
			...
			<div class="order-info">
				<div class="order-num"><p><span class="">订单号：160512588151945</span> 状态：已完成</p></div>
				<div class="order-zt"><p><i></i>本次交易完成。欢迎再次光临体验，祝您生活愉快！</p></div>
				<div class="order-in">
					<p>订单金额：<span>￥286.00</span>(已免运费)</p>
					<p class="mt10">发货仓库：北京站</p>
					<p>收货信息：赵某某，</p>
					<p>支付方式：银行卡</p>
					<p>送货方式：快递送货上门（不限时间送货）</p>
				</div>
			</div>
		</div>
		<!---->
		...
		<div class="order-track">
			...
			<ul class="order-state">
				<li class="st1 on"><span>提交订单</span></li>
				<li class="st2 on"><span>支付成功</span></li>
				<li class="st3 on"><span>已审核</span></li>
				<li class="st4 on"><span>已发货</span></li>
				<li class="st5"><span>已完成</span></li>
			</ul>
			<h4>订单跟踪详情</h4>
			<dl class="clearfix dl-tit"><dt>处理时间</dt><dd class="ord-dd">订单处理</dd><dd class="ord-dd2">操作人</dd></dl>
			<dl class="clearfix"><dt>2016-05-18 00:03:34</dt><dd class="ord-dd">您的订单已经提交，商品预计在05月19号（周四）前送达</dd><dd class="ord-dd2">会员</dd></dl>
			<dl class="clearfix"><dt>2016-05-18 00:03:34</dt><dd class="ord-dd">您的订单已经提交，商品预计在05月19号（周四）前送达</dd><dd class="ord-dd2">会员</dd></dl>
			<dl class="clearfix"><dt>2016-05-18 00:03:34</dt><dd class="ord-dd">您的订单已经提交，商品预计在05月19号（周四）前送达</dd><dd class="ord-dd2">会员</dd></dl>
			<dl class="clearfix"><dt>2016-05-18 00:03:34</dt><dd class="ord-dd">您的订单已经提交，商品预计在05月19号（周四）前送达</dd><dd class="ord-dd2">会员</dd></dl>
			<dl class="clearfix"><dt>2016-05-18 00:03:34</dt><dd class="ord-dd">您的订单已经提交，商品预计在05月19号（周四）前送达</dd><dd class="ord-dd2">会员</dd></dl>
