...
<div class="information w1200">
	<!--消息列表-->
	<div class="info-list">
		<ul class="info-ul info-tit clearfix">
			<li class="li1">时间</li>
			<li class="li2">标题</li>
			<li class="li3">内容</li>
			<li class="li4">状态</li>
		...
		<div class="info-con">
			<ul class="info-ul info-ul2 clearfix">
				<li class="li1">2016.09.01</li>
				<li class="li2"><a href="news-info.jsp">提现未到帐</a></li>
				<li class="li3">您好，本人赵某某，于2016年8月30日18:20申请提现2000元，但现查询银行卡上余额显示仍... </li>
				<li class="li4">已回复</li>
			</ul>
			<ul class="info-ul info-ul2 clearfix">
				<li class="li1">2016.09.01</li>
			...
			<ul class="info-ul info-ul2 clearfix">
				<li class="li1">2016.09.01</li>
				<li class="li2"><a href="news-info.jsp">提现未到帐</a></li>
				<li class="li3">您好，本人赵某某，于2016年8月30日18:20申请提现2000元，但现查询银行卡上余额显示仍20申请提现2000元，但现查询银行卡上余额显示仍... </li>
				<li class="li4">已回复</li>
			</ul>
			<ul class="info-ul info-ul2 clearfix">
				<li class="li1">2016.09.01</li>
