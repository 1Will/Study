...
<div class="customer w1200 clearfix">
		...
		<ul>
			<li>
				...
				<div class="cust-nav">
					...
					<p class="on"><a href="order-address.jsp">收货地址</a></p>
				</div>
			</li>
			<li>
	...
	<!--/左侧菜单-->
	<!--服务内容-->
	<div class="w1018 bor1 fr">
		<!---->
		<div class="addressList">
			<div class="addressList-tit">
				<h3>已保存的收货地址<span>您已创建<i>2</i>个收货地址，最多可创建<i>3</i>个</span></h3>
			</div>
			<div class="addressList-list">
				<ul class="clearfix">
					<li class="alia">
						<div class="addr-name"><i class="icon2 ic1"></i>赵某某</div>
						<div class="addr-dz"><i class="icon2 ic2"></i><span>北京市 朝阳区 东坝地区 阳光街阳光小区15-15-15</span></div>
						<div class="addr-tel"><i class="icon2 ic3"></i>182*****000 <div class="extra"><a href="order-address.jsp">修改</a></div></div>
						<div class="alias">默认地址</div>
					</li>
					<li>
						<div class="addr-name"><i class="icon2 ic1"></i>赵某某</div>
						<div class="addr-dz"><i class="icon2 ic2"></i><span>北京市 朝阳区 东坝地区 阳光街阳光小区15-15-15</span></div>
						<div class="addr-tel"><i class="icon2 ic3"></i>182*****000 <div class="extra"><a href="order-address.jsp">修改</a><a href="javascript:;">删除</a></div></div>
						<div class="alias alias-n">默认地址</div>
					</li>
					<li>
						<div class="addr-name"><i class="icon2 ic1"></i>赵某某</div>
						<div class="addr-dz"><i class="icon2 ic2"></i><span>北京市 朝阳区 东坝地区 阳光街阳光小区15-15-15</span></div>
		...
		<div class="addressmodify">
			...
			<div class="addr-con">
				<dl class="addr-item clearfix"><dt>收货人：</dt><dd><input class="item-name" type="text" placeholder="赵某某"></dd></dl>
				<dl class="addr-item clearfix"><dt>地址：</dt>
					<dd>
						<div class="sel-add">
							<select name="" id="">
								<option value="1">北京市1</option>
								<option value="1">北京市2</option>
								<option value="1">北京市3</option>
							</select>
						</div>
						<div class="sel-add">
							<select name="" id="">
								<option value="1">朝阳区1</option>
								<option value="1">朝阳区2</option>
								<option value="1">朝阳区3</option>
							</select>
						</div>
						<div class="sel-add">
							<select name="" id="">
								<option value="1">阳光街1</option>
								<option value="1">阳光街2</option>
								<option value="1">阳光街3</option>
							</select>
						</div>
						<div class="sel-add">
							<select name="" id="">
				...
				<dl class="addr-item clearfix"><dt></dt><dd><input class="item-name" type="text" placeholder="阳光小区15-15-15"></dd></dl>
				<dl class="addr-item clearfix"><dt>手机：</dt><dd><input class="item-tel" type="text" placeholder="182******000"></dd></dl>
				<dl class="addr-item clearfix"><dt>备用电话：</dt><dd><input class="item-tel" type="text" placeholder="手机/区号-固定电话"></dd></dl>
			</div>
			<div class="addr-btn">
				<a href="">保存收货地址</a>
			</div>
