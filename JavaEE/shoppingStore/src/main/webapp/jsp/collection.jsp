...
<div class="crumb-wrap w1200 clearfix">
	...
	<div class="crumb">我的收藏</div>
</div>
<!--/位置-->
<!--我的收藏-->
<div class="collection w1200">
	<h2 class="coll-tit">已收藏的宝贝</h2>
	<ul class="coll-nav clearfix">
		<li class="on">全部<span>4</span></li>
	</ul>
	<ul class="coll-con clearfix">
		<li>
			<a href="article.jsp">
				<div class="coll-img"><img src="images/sp9.jpg" alt=""></div>
				<div class="coll-jg"><span>￥</span>19.9</div>
				<p class="coll-name">澳大利亚奔富酒园BIN28红葡萄酒750ml（又名：奔富宾28卡</p>
			</a>
			<span class="coll-gb"></span>
		</li>
		<li>
			<a href="article.jsp">
				<div class="coll-img"><img src="images/sp9.jpg" alt=""></div>
