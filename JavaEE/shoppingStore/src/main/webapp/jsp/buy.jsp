...
<div class="w1200">
	<div class="buy">
		...
		<div class="buy-name">
			<h2>确认订单</h2>
			<i class="buy-i"></i>
			<div class="buy-t">请在<span>24小时</span>内支付</div>
		</div>
		<!--buy-address-->
		<div class="buy-tit clearfix">
			<h3>收货地址</h3>
			<a href="order-address2.jsp">新增收货地址</a>
		</div>
		<div class="addressList-list buy-address">
			<ul class="clearfix">
				<li class="alia">
		...
		<div class="buy-tit clearfix">
			<h3>商品清单</h3>
			<a href="cart.jsp">返回购物车修改商品</a>
		</div>
		<div class="buy-detailed">
			<table class="buy-tab">
				<thead>
					<tr>
						<th></th>
				...
				<tbody>
					<tr>
						<td><div class="buy-img"><a href="article.jsp"><img src="images/img4.jpg" alt=""></a></div></td>
						<td><div class="buy-p"><a href="article.jsp">澳大利亚奔富BIN138干红葡萄酒750ml</a></div></td>
						<td><div class="buy-price">219.00</div></td>
						<td><div class="buy-num">1</div></td>
						<td><div class="buy-total"><b>￥ 219</b></div></td>
					</tr>
					<tr>
						<td><div class="buy-img"><a href="article.jsp"><img src="images/img4.jpg" alt=""></a></div></td>
						<td><div class="buy-p"><a href="article.jsp">澳大利亚奔富BIN138干红葡萄酒750ml</a></div></td>
		...
		<div class="buy-sub">
			<div class="buy-sub-p">共有<span>2</span>件商品，总计：<b><span>￥ 438</span></b></div>
			<div class="buy-sub-p">运费 0 元</div>
			<div class="buy-sub-a"><a href="order.jsp">提交订单</a></div>
		</div>
	</div>
</div>
<!--/提交订单-->
