...
<div class="customer w1200 clearfix">
	...
	<div class="w1018 bor1 fr">
		...
		<div class="addressmodify">
			...
			<div class="addr-con">
				<dl class="addr-item clearfix"><dt>收货人：</dt><dd><input class="item-name" type="text"></dd></dl>
				...
				<dl class="addr-item clearfix"><dt></dt><dd><input class="item-name" type="text"></dd></dl>
				<dl class="addr-item clearfix"><dt>手机：</dt><dd><input class="item-tel" type="text"></dd></dl>
				<dl class="addr-item clearfix"><dt>备用电话：</dt><dd><input class="item-tel" type="text"></dd></dl>
			</div>
			<div class="addr-btn">
				<a href="">保存收货地址</a>
			</div>
