...
<div class="evaluate popup">
	...
	<div class="eval">
		<div class="eval-imp clearfix">
			<div class="eval-imc fl">
				<img src="images/sp8.jpg" alt="">
			</div>
			<div class="fl">
				<div class="eval-xx clearfix"><span class="on"></span><span></span><span></span><span></span><i><em>1</em>分</i></div>
				<ul class="eval-img-list clearfix">
					<li><img src="images/sp8.jpg" alt=""></li>
					<li><img src="images/sp8.jpg" alt=""></li>
					<li><img src="images/sp8.jpg" alt=""></li>
					<li><img src="images/sp8.jpg" alt=""></li>
				</ul>
				<p class="eval-img-p">挺好的 很满意 [ 2016-08-28]</p>
			</div>
		</div>
