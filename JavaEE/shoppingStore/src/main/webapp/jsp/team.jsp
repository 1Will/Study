	...
	<div class="cust-menu fl">
		<ul>
			...
			<li>
				...
				<div class="cust-nav">
					<p class="on"><a href="team.jsp">我的团队</a></p>
				</div>
			</li>
			<li>
	...
	<div class="w1018 fr">
		...
		<div class="team clearfix">
			...
			<div class="team-con fl">
				...
				<div class="team-per clearfix">
					<div class="team-per-a"><p>我的团队：<span>5</span>人</p></div>
					<div class="team-per-b"></div>
					<div class="team-per-c">
						<p>一级会员：1人</p>
						<p>一级会员：2人</p>
						<p>一级会员：3人</p>
					</div>
		...
		<!--团队信息-->
		<div class="team-list">
			<dl class="team-list-tit clearfix"><dt>序号</dt><dd class="tea1">会员ID</dd><dd class="tea2">会员昵称</dd><dd class="tea3">会员级别</dd><dd class="tea4">团队人数</dd><dd class="tea5">加入日期</dd></dl>
			<dl class="clearfix"><dt>1.</dt><dd class="tea1">80001249</dd><dd class="tea2">昵称:豆芽儿</dd><dd class="tea3">一级会员</dd><dd class="tea4">2 人</dd><dd class="tea5">016.9.15 20:54</dd></dl>
			<dl class="clearfix"><dt>1.</dt><dd class="tea1">80001249</dd><dd class="tea2">昵称:豆芽儿</dd><dd class="tea3">一级会员</dd><dd class="tea4">2 人</dd><dd class="tea5">016.9.15 20:54</dd></dl>
			<dl class="clearfix"><dt>1.</dt><dd class="tea1">80001249</dd><dd class="tea2">昵称:豆芽儿</dd><dd class="tea3">一级会员</dd><dd class="tea4">2 人</dd><dd class="tea5">016.9.15 20:54</dd></dl>
			<dl class="clearfix"><dt>1.</dt><dd class="tea1">80001249</dd><dd class="tea2">昵称:豆芽儿</dd><dd class="tea3">一级会员</dd><dd class="tea4">2 人</dd><dd class="tea5">016.9.15 20:54</dd></dl>
		</div>
