		...
		<ul>
			...
			<li>
				...
				<div class="cust-nav">
					...
					<p class="on"><a href="user-information.jsp">个人信息</a></p>
	...
	<div class="w1018 fr">
		...
		<div class="team clearfix">
			...
			<div class="team-con ww fl">
				...
				<ul class="team-inf clearfix">
					<li class="assets-red"><i class="io io3"></i><span>可提现余额：<i class="ia1">5000.00</i> 元</span></li>
					<li class="assets-red"><i class="io io4"></i><span>提现额度 ： <i class="ia2">50000.00</i> 元</span></li>
				...
				<ul class="team-ina clearfix">
					<li><em>账户总收入：</em><span>￥10000</span></li>
					<li><em>今日收入： </em><span>￥10</span></li>
					<li><em>冻结资金： </em><span>￥500</span></li>
					<li><em>金额转出： </em><span>￥4500</span></li>
				</ul>
			</div>
			<!---->
			<div class="notice fr">
				<div class="notice-item">
					...
					<div class="notice-info">
						<p>中秋9月15-17平台停止提现操作，9月18日恢复正常。</p>
						<p>特此公告。</p>
					</div>
